...
not_run: WebUI.click(findTestObject('Page_Setup  Asyst HRPMS/button_ Add Strategic Objective'))

not_run: WebUI.setText(findTestObject('Page_Setup  Asyst HRPMS/input_Strategic Objective_1'), 'Test Strategy')

not_run: WebUI.click(findTestObject('Page_Setup  Asyst HRPMS/button_Add'))
