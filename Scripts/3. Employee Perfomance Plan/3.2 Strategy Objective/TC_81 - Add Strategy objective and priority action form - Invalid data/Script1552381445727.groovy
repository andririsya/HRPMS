...
WebUI.setText(findTestObject('Page_Setup  Asyst HRPMS/input_Control Point_1'), 'Control Point SO')

WebUI.setText(findTestObject('Page_Setup  Asyst HRPMS/input_Delete_1'), 'fghjh')
...
WebUI.verifyElementPresent(findTestObject('Page_Setup  Asyst HRPMS/div_weight Is Required'), 30)
