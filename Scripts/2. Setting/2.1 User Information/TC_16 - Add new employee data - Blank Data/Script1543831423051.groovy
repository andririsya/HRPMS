...
WebUI.setText(findTestObject('Object Repository/Page_User Information  Asyst HRPMS/input_Name_1'), '')

WebUI.setText(findTestObject('Object Repository/Page_User Information  Asyst HRPMS/input_NIK_1'), '')

WebUI.setText(findTestObject('Object Repository/Page_User Information  Asyst HRPMS/input_Email_1'), '')

WebUI.click(findTestObject('Object Repository/Page_User Information  Asyst HRPMS/button_Submit'))

WebUI.verifyElementPresent(findTestObject('Page_User Information  Asyst HRPMS/div_Employee Name is Required'), 30)
