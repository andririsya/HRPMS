...
WebUI.click(findTestObject('Object Repository/Page_User Information  Asyst HRPMS/i_Subordinate_dripicons-pencil'))

WebUI.setText(findTestObject('Object Repository/Page_User Information  Asyst HRPMS/input_Name_1'), 'Edit Tester')

WebUI.click(findTestObject('Object Repository/Page_User Information  Asyst HRPMS/button_Submit'))

WebUI.click(findTestObject('Object Repository/Page_User Information  Asyst HRPMS/div_Success update employee da'))
