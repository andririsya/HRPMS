...
WebUI.click(findTestObject('Page_User Information  Asyst HRPMS/i_Subordinate_dripicons-pencil'))
...
WebUI.verifyElementPresent(findTestObject('Page_User Information  Asyst HRPMS/div_Success update employee da'), 0)
