...
WebUI.click(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/div_Period 5First MonthSelectJ'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/select_SelectJanuaryFebruaryMa'), 
    '5', true)

WebUI.scrollToElement(findTestObject('Page_Manage Period  Asyst HRPMS/div_Period 9First MonthSelectJ'), 30)

WebUI.click(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/div_Period 6First MonthSelectJ'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/select_SelectJanuaryFebruaryMa'), 
    '6', true)

WebUI.click(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/div_Period 7First MonthSelectJ'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/select_SelectJanuaryFebruaryMa'), 
    '7', true)

WebUI.click(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/div_Period 8First MonthSelectJ'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/select_SelectJanuaryFebruaryMa'), 
    '8', true)

WebUI.click(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/div_Period 9First MonthSelectJ'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/select_SelectJanuaryFebruaryMa'), 
    '9', true)

WebUI.scrollToElement(findTestObject('Page_Manage Period  Asyst HRPMS/button_Save'), 30)

WebUI.click(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/div_Period 10First MonthSelect'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/select_SelectJanuaryFebruaryMa'), 
    '10', true)

WebUI.click(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/div_Period 11First MonthSelect'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/select_SelectJanuaryFebruaryMa'), 
    '11', true)

WebUI.click(findTestObject('Object Repository/Page_Manage Period  Asyst HRPMS/div_Period 12First MonthSelect'))
