...
WebUI.setText(findTestObject('Object Repository/Page_Achievement Category  Asyst HR/input_Min.Value Achievement_1'), '10')

WebUI.setText(findTestObject('Page_Achievement Category  Asyst HR/input_Select Amount of Achieve5'), 
    'Up')

WebUI.setText(findTestObject('Object Repository/Page_Achievement Category  Asyst HR/input_Max.Value Achievement_1'), '25')
