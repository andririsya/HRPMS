...
WebUI.setText(findTestObject('Page_Achievement Category  Asyst HR/input_Min.Value Achievement_1'), '25')

WebUI.setText(findTestObject('Page_Achievement Category  Asyst HR/input_Max.Value Achievement_1'), '10')

WebUI.click(findTestObject('Object Repository/Page_Achievement Category  Asyst HR/button_Save'))

WebUI.verifyElementVisibleInViewport(findTestObject('Object Repository/Page_Achievement Category  Asyst HR/div_Max.Value Must Be Greater'), 
    30)
